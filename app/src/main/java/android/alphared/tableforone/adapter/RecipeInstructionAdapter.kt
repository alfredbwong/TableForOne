package android.alphared.tableforone.adapter

import android.alphared.tableforone.databinding.RecipeInstructionBinding
...
class RecipeInstructionAdapter : ListAdapter<String, RecipeInstructionAdapter.ViewHolder> (RecipeInstructionDiffCallback()){
