package android.alphared.tableforone.meal

import android.content.Context
import android.alphared.tableforone.BASE_URL
import android.alphared.tableforone.MealReminderRepository
import android.alphared.tableforone.meal.category.MealCategory
import android.alphared.tableforone.meal.database.MealCategoryDatabase
import android.alphared.tableforone.meal.recipe.MealRecipe
import android.alphared.tableforone.meal.recipe.MealRecipeDatabase
import android.alphared.tableforone.meal.reminder.MealReminder
import android.alphared.tableforone.meal.reminder.MealReminderDatabase
import android.alphared.tableforone.meal.select.MealCategoryItemDatabase
import android.alphared.tableforone.meal.select.MealCategoryItem
import android.alphared.tableforone.network.MealApiService
